...
<svg role="img" aria-label="도트 픽셀 오크 캠프 부감: 캠프파이어 주위로 텐트(캠프)들이 흩어져 있고, 망치를 휘두르는 오크(active), 말풍선을 띄운 오크(waiting), 조는 오크(idle), 연기가 피어오르는 오크(error)가 각자 일하는 가운데, 오른쪽 관제 모니터 Campfire Dashboard가 모든 캠프의 상태를 한 화면으로 모아 본다" viewBox="0 0 760 340" xmlns="http://www.w3.org/2000/svg">
  <title>오크 캠프와 캠프파이어 대시보드</title>

  <!-- 땅의 도트 텍스처 -->
  <g fill="currentColor" opacity="0.12" shape-rendering="crispEdges">
    <rect x="70" y="150" width="3" height="3"/>
    <rect x="180" y="130" width="3" height="3"/>
    <rect x="240" y="200" width="3" height="3"/>
    <rect x="300" y="300" width="3" height="3"/>
    <rect x="380" y="150" width="3" height="3"/>
    <rect x="420" y="280" width="3" height="3"/>
    <rect x="480" y="120" width="3" height="3"/>
    <rect x="200" y="300" width="3" height="3"/>
    <rect x="120" y="300" width="3" height="3"/>
    <rect x="470" y="250" width="3" height="3"/>
    <rect x="360" y="90" width="3" height="3"/>
    <rect x="90" y="180" width="3" height="3"/>
  </g>

  <!-- 관제 모니터의 시선 (대시보드 → 각 오크/캠프) -->
  <g stroke="currentColor" stroke-width="1.5" stroke-dasharray="4 4" opacity="0.3">
    <line x1="532" y1="110" x2="292" y2="130"/>
    <line x1="532" y1="148" x2="180" y2="248"/>
    <line x1="532" y1="186" x2="150" y2="188"/>
    <line x1="532" y1="222" x2="442" y2="200"/>
  </g>

  <!-- 텐트 A (tmux 세션 = 캠프) -->
  <g>
    <path d="M 66,84 L 78,84 L 78,94 L 86,94 L 86,106 L 96,106 L 96,117 L 104,117 L 104,128 L 40,128 L 40,117 L 48,117 L 48,106 L 58,106 L 58,94 L 66,94 Z" fill="currentColor" fill-opacity="0.12" stroke="currentColor" stroke-width="2"/>
    <rect x="66" y="112" width="12" height="16" fill="currentColor" opacity="0.55" shape-rendering="crispEdges"/>
    <line x1="72" y1="84" x2="72" y2="70" stroke="currentColor" stroke-width="2"/>
    <rect x="72" y="70" width="12" height="7" fill="var(--crimson)" shape-rendering="crispEdges"/>
  </g>

  <!-- 텐트 B -->
  <g>
    <path d="M 202,58 L 214,58 L 214,68 L 222,68 L 222,80 L 232,80 L 232,91 L 240,91 L 240,102 L 176,102 L 176,91 L 184,91 L 184,80 L 194,80 L 194,68 L 202,68 Z" fill="currentColor" fill-opacity="0.12" stroke="currentColor" stroke-width="2"/>
    <rect x="202" y="86" width="12" height="16" fill="currentColor" opacity="0.55" shape-rendering="crispEdges"/>
    <line x1="208" y1="58" x2="208" y2="44" stroke="currentColor" stroke-width="2"/>
    <rect x="208" y="44" width="12" height="7" fill="var(--crimson)" shape-rendering="crispEdges"/>
  </g>

  <!-- 텐트 C -->
  <g>
    <path d="M 84,214 L 96,214 L 96,224 L 104,224 L 104,236 L 114,236 L 114,247 L 122,247 L 122,258 L 58,258 L 58,247 L 66,247 L 66,236 L 76,236 L 76,224 L 84,224 Z" fill="currentColor" fill-opacity="0.12" stroke="currentColor" stroke-width="2"/>
    <rect x="84" y="242" width="12" height="16" fill="currentColor" opacity="0.55" shape-rendering="crispEdges"/>
    <line x1="90" y1="214" x2="90" y2="200" stroke="currentColor" stroke-width="2"/>
    <rect x="90" y="200" width="12" height="7" fill="var(--crimson)" shape-rendering="crispEdges"/>
  </g>

  <!-- 캠프파이어 -->
  <circle cx="330" cy="242" r="36" fill="var(--gold-soft)"/>
  <g shape-rendering="crispEdges">
    <rect x="302" y="258" width="7" height="5" fill="currentColor" opacity="0.45"/>
    <rect x="351" y="258" width="7" height="5" fill="currentColor" opacity="0.45"/>
    <rect x="312" y="265" width="7" height="5" fill="currentColor" opacity="0.45"/>
    <rect x="341" y="265" width="7" height="5" fill="currentColor" opacity="0.45"/>
    <rect x="326" y="267" width="8" height="5" fill="currentColor" opacity="0.45"/>
    <rect x="310" y="252" width="40" height="6" fill="currentColor" opacity="0.75"/>
    <rect x="316" y="246" width="28" height="6" fill="currentColor" opacity="0.55"/>
    <rect x="320" y="224" width="20" height="22" fill="var(--crimson)"/>
    <rect x="324" y="212" width="12" height="16" fill="var(--gold)"/>
    <rect x="327" y="204" width="6" height="10" fill="var(--gold-bright)"/>
  </g>

  <!-- 오크 1: active (망치질) -->
  <g shape-rendering="crispEdges">
    <rect x="170" y="226" width="12" height="6" fill="currentColor"/>
    <rect x="174" y="232" width="3" height="14" fill="var(--gold)"/>
    <rect x="185" y="220" width="3" height="3" fill="var(--gold-bright)"/>
    <rect x="190" y="227" width="3" height="3" fill="var(--gold-bright)"/>
    <rect x="159" y="244" width="12" height="9" fill="var(--orc-green)"/>
    <rect x="161" y="247" width="2" height="2" fill="currentColor"/>
    <rect x="167" y="247" width="2" height="2" fill="currentColor"/>
    <rect x="160" y="251" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="168" y="251" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="157" y="253" width="16" height="10" fill="var(--orc-green-deep)"/>
    <rect x="157" y="258" width="16" height="3" fill="currentColor" opacity="0.55"/>
    <rect x="160" y="263" width="4" height="6" fill="currentColor" opacity="0.7"/>
    <rect x="166" y="263" width="4" height="6" fill="currentColor" opacity="0.7"/>
  </g>
  <rect x="140" y="280" width="6" height="6" fill="var(--orc-green)" shape-rendering="crispEdges"/>
  <text x="150" y="287" font-size="9" fill="currentColor" opacity="0.75">active</text>

  <!-- 오크 2: waiting (말풍선) -->
  <g shape-rendering="crispEdges">
    <rect x="271" y="126" width="12" height="9" fill="var(--orc-green)"/>
    <rect x="273" y="129" width="2" height="2" fill="currentColor"/>
    <rect x="279" y="129" width="2" height="2" fill="currentColor"/>
    <rect x="272" y="133" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="280" y="133" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="269" y="135" width="16" height="10" fill="var(--orc-green-deep)"/>
    <rect x="269" y="140" width="16" height="3" fill="currentColor" opacity="0.55"/>
    <rect x="272" y="145" width="4" height="6" fill="currentColor" opacity="0.7"/>
    <rect x="278" y="145" width="4" height="6" fill="currentColor" opacity="0.7"/>
  </g>
  <rect x="282" y="102" width="30" height="16" fill="var(--gold-soft)" stroke="currentColor" stroke-width="1.5"/>
  <line x1="286" y1="118" x2="280" y2="126" stroke="currentColor" stroke-width="1.5"/>
  <g fill="currentColor" shape-rendering="crispEdges">
    <rect x="288" y="108" width="3" height="3"/>
    <rect x="294" y="108" width="3" height="3"/>
    <rect x="300" y="108" width="3" height="3"/>
  </g>
  <rect x="252" y="158" width="6" height="6" fill="var(--gold)" shape-rendering="crispEdges"/>
  <text x="262" y="165" font-size="9" fill="currentColor" opacity="0.75">waiting</text>

  <!-- 오크 3: idle (졸고 있음) -->
  <g shape-rendering="crispEdges" opacity="0.85">
    <rect x="131" y="180" width="12" height="9" fill="var(--orc-green)"/>
    <rect x="133" y="184" width="2" height="1" fill="currentColor"/>
    <rect x="139" y="184" width="2" height="1" fill="currentColor"/>
    <rect x="132" y="187" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="140" y="187" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="129" y="189" width="16" height="10" fill="var(--orc-green-deep)"/>
    <rect x="129" y="194" width="16" height="3" fill="currentColor" opacity="0.55"/>
    <rect x="132" y="199" width="4" height="6" fill="currentColor" opacity="0.7"/>
    <rect x="138" y="199" width="4" height="6" fill="currentColor" opacity="0.7"/>
  </g>
  <text x="150" y="176" font-size="10" fill="currentColor" opacity="0.5">z</text>
  <text x="156" y="168" font-size="8" fill="currentColor" opacity="0.4">z</text>
  <rect x="114" y="210" width="6" height="6" fill="currentColor" opacity="0.35" shape-rendering="crispEdges"/>
  <text x="124" y="217" font-size="9" fill="currentColor" opacity="0.75">idle</text>

  <!-- 오크 4: error (연기) -->
  <g shape-rendering="crispEdges">
    <rect x="427" y="182" width="5" height="5" fill="currentColor" opacity="0.3"/>
    <rect x="431" y="172" width="6" height="6" fill="currentColor" opacity="0.22"/>
    <rect x="424" y="162" width="7" height="7" fill="currentColor" opacity="0.15"/>
    <rect x="423" y="196" width="12" height="9" fill="var(--orc-green)"/>
    <rect x="425" y="199" width="2" height="2" fill="currentColor"/>
    <rect x="431" y="199" width="2" height="2" fill="currentColor"/>
    <rect x="424" y="203" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="432" y="203" width="2" height="3" fill="var(--bg-panel)"/>
    <rect x="421" y="205" width="16" height="10" fill="var(--orc-green-deep)"/>
    <rect x="421" y="210" width="16" height="3" fill="currentColor" opacity="0.55"/>
    <rect x="424" y="215" width="4" height="6" fill="currentColor" opacity="0.7"/>
    <rect x="430" y="215" width="4" height="6" fill="currentColor" opacity="0.7"/>
  </g>
  <text x="444" y="188" font-size="13" font-weight="700" fill="var(--crimson)">!</text>
  <rect x="406" y="232" width="6" height="6" fill="var(--crimson)" shape-rendering="crispEdges"/>
  <text x="416" y="239" font-size="9" fill="currentColor" opacity="0.75">error</text>

  <!-- 관제 모니터: Campfire Dashboard -->
  <rect x="624" y="268" width="16" height="16" fill="currentColor" opacity="0.6" shape-rendering="crispEdges"/>
  <rect x="600" y="284" width="64" height="8" fill="currentColor" opacity="0.8" shape-rendering="crispEdges"/>
  <rect x="532" y="58" width="208" height="210" fill="none" stroke="currentColor" stroke-width="3"/>
  <rect x="538" y="64" width="196" height="198" fill="none" stroke="var(--gold)" stroke-width="1.5" opacity="0.8"/>
  <text x="636" y="82" font-size="9.5" font-weight="600" letter-spacing="1.5" text-anchor="middle" fill="currentColor" opacity="0.8">CAMPFIRE DASHBOARD</text>
  <line x1="544" y1="90" x2="728" y2="90" stroke="currentColor" stroke-width="1" opacity="0.4"/>
  <text x="552" y="114" font-size="9.5" fill="currentColor">camp / alpha</text>
  <line x1="552" y1="121" x2="640" y2="121" stroke="currentColor" stroke-width="2" opacity="0.3"/>
  <circle cx="716" cy="110" r="4.5" fill="var(--orc-green)"/>
  <text x="552" y="148" font-size="9.5" fill="currentColor">camp / bravo</text>
  <line x1="552" y1="155" x2="622" y2="155" stroke="currentColor" stroke-width="2" opacity="0.3"/>
  <circle cx="716" cy="144" r="4.5" fill="var(--gold)"/>
  <text x="552" y="182" font-size="9.5" fill="currentColor">camp / forge</text>
  <line x1="552" y1="189" x2="606" y2="189" stroke="currentColor" stroke-width="2" opacity="0.3"/>
  <circle cx="716" cy="178" r="4.5" fill="var(--crimson)"/>
  <text x="552" y="216" font-size="9.5" fill="currentColor" opacity="0.75">camp / docs</text>
  <line x1="552" y1="223" x2="632" y2="223" stroke="currentColor" stroke-width="2" opacity="0.25"/>
  <circle cx="716" cy="212" r="4.5" fill="currentColor" opacity="0.35"/>
  <text x="552" y="250" font-size="8.5" fill="currentColor" opacity="0.55">127.0.0.1 · read-only scan</text>
</svg>
<figcaption>tmux 세션은 캠프(Camp), pane 속 에이전트는 오크(Orc) — 흩어진 캠프들의 상태를 Campfire Dashboard 하나가 내려다본다.</figcaption>
</figure>
