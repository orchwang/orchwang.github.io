---
layout: post
title: "Process Essential Curriculum"
date: 2026-06-19
...
flowchart TD
    ...
    subgraph FOUNDATION["기초 · 큰 그림과 애자일 가치"]
        S1["1단계<br/>소프트웨어 공학 개관"]
        S2["2단계<br/>XP · 애자일 가치"]
    end

    subgraph CORE["핵심 · 요구사항과 유스케이스"]
        S3["3단계<br/>사용자 스토리"]
        S4["4단계<br/>유스케이스 작성법"]
        S5["5단계<br/>유스케이스 주도 개발"]
    end

    subgraph APPLY["응용 · 현대적 실천"]
        S6["6단계<br/>지속적 통합(CI)"]
