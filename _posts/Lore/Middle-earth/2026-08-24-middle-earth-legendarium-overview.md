---
layout: post
title: "하나의 세계, 세 권의 책: 톨킨 레젠다리움과 하위창조"
date: 2026-08-24 00:01:00
categories: [Lore, Middle-earth]
series: Middle-earth-Lore
tags: [lore, worldbuilding, tolkien, middle-earth, sub-creation, legendarium]
published: true
image: /assets/images/lore/middle-earth-legendarium-overview-og.jpg
excerpt: "실마릴리온·호빗·반지의 제왕은 세 편의 판타지가 아니라 한 세계의 세 창(窓)이다. 톨킨의 창작 철학 '하위창조'와, 언어에서 신화로 자라난 레젠다리움의 형성 과정을 정리한다."
---
...
<picture>
  ...
  <img src="/assets/images/lore/middle-earth-legendarium-overview.jpg" alt="촛불 켜진 돌벽 서재에서 회색 로브를 입은 로어마스터가 펼친 책을 마주하고 있다. 책에서 앰버빛 안개와 빛줄기가 피어오르며 그 위로 작은 중간계 풍경 — 흰 탑, 용암을 뿜는 어두운 산, 초록 언덕과 굽이진 강 — 이 솟아오른다. 왼쪽 아치창 너머로 달과 산맥이 보이고, 오른쪽 선반에는 두루마리와 책이 쌓여 있다. 레트로 픽셀아트." width="1536" height="1024" loading="lazy" decoding="async">
</picture>
